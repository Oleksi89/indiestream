        ...
        return (
            ...
            >
                <div className={cn(
                    ...
                    {isLikedTracks ? (
                        <Heart className="w-12 h-12 text-white fill-white shadow-sm"/>
                    ) : playlist.coverMinioPath ? (
                        <img src={playlist.coverMinioPath} alt={playlist.name} className="w-full h-full object-cover"/>
                    ) : (
                        <span className="text-4xl font-bold text-slate-600">{playlist.name[0]}</span>
                    )}
                </div>
        ...
        >
            <div className={cn(
                ...
                {isLikedTracks ? (
                    ...
                    <span className="text-lg font-bold text-slate-400">{playlist.name[0]}</span>
                )}
            </div>
