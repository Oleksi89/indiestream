        ...
        <div className="flex flex-col gap-6 animate-in fade-in duration-300">
            <div
                ...
                <Button
                    ...
                    aria-label={exportMutation.isPending ? t.analytics.deepDive.exporting : t.analytics.deepDive.exportCsv}
                ...
                >
                    {exportMutation.isPending ? <Loader2 size={16} className="animate-spin mr-2" aria-hidden="true"/> :
                        <Download size={16} className="mr-2" aria-hidden="true"/>}
                    {t.analytics.deepDive.exportCsv}
                </Button>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <SummaryMetricCard title={t.analytics.metrics.completionRate}
                                   ...
                                   format="percent"/>
                <SummaryMetricCard title={t.analytics.metrics.skipRate} value={data.engagement.skipRatePercentage}
                                   format="percent"/>
            </div>
