...
export const DemographicsBarChart = ({data}: DemographicsBarChartProps) => {
    ...
    return (
        <div className="w-full bg-slate-900/30 border border-slate-800 rounded-xl p-6 h-[350px]">
            <h3 className="text-sm font-semibold text-slate-300 mb-6">{t.analytics.charts.topRegions}</h3>
            <ResponsiveContainer width="100%" height="100%">
                <BarChart data={data} layout="vertical" margin={{top: 0, right: 20, left: 0, bottom: 0}}>
                    ...
                    />
                    <Bar dataKey="listeners" name={t.analytics.metrics.listeners} radius={[0, 4, 4, 0]} barSize={20}>
